...
const I18N = {
  zh: {
    ...
    adviceStale: '昨日引擎未跑成', adviceDead: '断更超两天 · 请检查自动化', adviceNoData: '暂无推荐数据',
    adviceToday: '今日出票', adviceHistory: '战绩档案', adviceBudget: '日预算', adviceCurve: '资金曲线', adviceTz: '（北京）',
    standings: '积分榜',
    knockout: '淘汰赛',
    group: '小组',
    team: '球队',
    ...
    lotteryHAFU: '半全场',
    lotteryCRS: '比分',
    lotteryOtherHome: '胜其他',
    lotteryOtherDraw: '平其他',
    lotteryOtherAway: '负其他',
    lotteryHome: '主胜',
    lotteryDraw: '平',
    lotteryAway: '客胜',
    lotteryHH: '胜胜',
    ...
    analysisHost: '主场优势',
    analysisTravel: '旅途疲劳',
    analysisEnvironment: '环境适应',
    analysisAge: '平均年龄',
    analysisAttack: '进攻火力',
    analysisDefense: '防守稳固',
    analysisInjury: '伤病停赛',
    matchStartingXI: '首发阵容',
    matchBench: '替补',
    matchFormation: '阵型',
    matchNoLineup: '阵容尚未公布',
    matchLineupNotAvailable: '阵容数据暂不可用',
    preMatchAnalysis: '赛前分析',
    preMatchXG: '预期进球(xG)',
    expectedLineup: '预计首发阵容',
    matchGoals: '进球',
    matchCards: '红黄牌',
    matchSubs: '换人',
    matchEventsTitle: '比赛事件',
    matchAssist: '助攻',
    ownGoal: '乌龙',
    matchStats: '技术统计',
    matchLoading: '加载中...',
    matchLoadFailed: '加载失败',
    matchClose: '关闭',
    matchNoEvents: '暂无比赛事件',
    scorers: '射手榜',
    scorersTitle: '射手榜',
    scorersSubtitle: '共 {count} 名球员取得进球',
    scorersPlayer: '球员',
    scorersTeam: '球队',
    scorersGoals: '进球',
  ...
  en: {
    ...
    schedule: 'Schedule',
    advice: 'Daily Picks', adviceRest: 'Rest day — no golden-zone matches', adviceFresh: 'Engine OK · last update',
    adviceStale: 'Engine missed yesterday', adviceDead: 'Stale >2 days — check automation', adviceNoData: 'No data yet',
    adviceToday: "Today's Tickets", adviceHistory: 'Track Record', adviceBudget: 'Daily budget', adviceCurve: 'Equity curve', adviceTz: ' (Beijing)',
    standings: 'Standings',
    knockout: 'Knockout',
    group: 'Group',
    team: 'Team',
    ...
    aetShort: 'a.e.t.',
    penShort: 'pen.',
    advancedByPen: 'Advances on penalties',
    advancedByET: 'Advances after extra time',
    ...
    lotteryCRS: 'Correct Score',
    lotteryOtherHome: 'Other H',
    lotteryOtherDraw: 'Other D',
    lotteryOtherAway: 'Other A',
    lotteryHome: 'Home',
    lotteryDraw: 'Draw',
    lotteryAway: 'Away',
    lotteryHH: 'H/H',
    ...
    analysisModel: '12-Factor Model',
    analysisMatchCount: '{count} matches',
    analysisClearEdge: 'Clear Edge',
    finalRoundTitle: 'Group Final Round',
    analysisEdge: 'Edge',
    ...
    analysisAge: 'Avg Age',
    analysisAttack: 'Attack',
    analysisDefense: 'Defense',
    analysisInjury: 'Injuries',
    matchStartingXI: 'Starting XI',
    matchBench: 'Bench',
    matchFormation: 'Formation',
    matchNoLineup: 'Lineup not yet announced',
    matchLineupNotAvailable: 'Lineup not available',
    preMatchAnalysis: 'Pre-Match Analysis',
    preMatchXG: 'Expected Goals (xG)',
    expectedLineup: 'Expected Lineup',
    matchGoals: 'Goals',
    matchCards: 'Cards',
    matchSubs: 'Subs',
    matchEventsTitle: 'Match Events',
    matchAssist: 'Assist',
    ownGoal: 'OG',
    matchStats: 'Match Stats',
    matchLoading: 'Loading...',
    matchLoadFailed: 'Failed to load',
    matchClose: 'Close',
    matchNoEvents: 'No match events',
    scorers: 'Top Scorers',
    scorersTitle: 'Top Scorers',
    scorersSubtitle: '{count} players on the scoresheet',
    scorersPlayer: 'Player',
    scorersTeam: 'Team',
    scorersGoals: 'Goals',
